...
Through the archways and around the edge of the island are NPCs, currently there are only 3 on the south.

These NPCs represent featured servers, the text above them will display server status information.
...
The lobby represents a major milestone and a bright future of expansion for Miners Online. Throughout the year we will be releasing new game modes as player interest grows.

All our development work is source-available on our GitHub https://github.com/miners-online/monorepo under the Miners Online Public Software License.
